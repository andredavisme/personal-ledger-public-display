# Architecture — Intake Form Field Specification
**Last Updated:** May 29, 2026
**Status:** Current

> This document defines every field on the intake form, the three-tier messaging strategy, CSV upload templates, and validation rules. All data captured here feeds directly into the community submission record in `public.submissions`.
...
## Related Files
- `docs/architecture/correction-reasons.md` — defines the rejection checklist driven by incomplete intake submissions
- `docs/architecture/page-outline.md` — data flow from intake form through admin review to Community Page
