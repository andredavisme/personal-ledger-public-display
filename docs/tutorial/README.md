...
| [04-structure-and-style.md](04-structure-and-style.md) | HTML structure and CSS styling — making things look like they belong together |
| [05-forms.md](05-forms.md) | Building the intake form — collecting information from your community |
| [06-deploying.md](06-deploying.md) | Publishing your site live on the internet for free |
| [07-protecting-admin.md](07-protecting-admin.md) | Building the admin page and protecting it with a login |
| [08-database.md](08-database.md) | What a database is, why it matters, and setting up Supabase |
| [09-connecting-form-to-database.md](09-connecting-form-to-database.md) | Making your form actually save data |
| [10-admin-review.md](10-admin-review.md) | Wiring the admin page to read real submissions from the database |
| [11-community-pages.md](11-community-pages.md) | Building public community pages from approved database records |
| [12-whats-next.md](12-whats-next.md) | Where to go from here, how to keep learning, and how to share what you built |
