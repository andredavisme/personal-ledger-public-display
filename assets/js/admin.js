    ...
    card.innerHTML = `
      <div class="reason-card__content">
        <div>
          ...
          <p class="reason-card__meta">Status: ${reason.active ? 'Active' : 'Inactive'} · Order: ${reason.sortOrder}</p>
        </div>
    ...
    card.innerHTML = `
      <div class="submission-card__header">
        <div>
          ...
          <p>${submission.submitter} · ${submission.email} · ${submission.location}</p>
        </div>
      ...
      <div class="submission-card__review">
        <div>
          ...
          <div class="checkbox-group">
            ${buildReasonCheckboxes(submission.id)}
          </div>
        </div>
